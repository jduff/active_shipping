...
class FedExTest < Test::Unit::TestCase
  ...
  def test_building_request_with_company_name_should_not_include_residential
    ...
    destination = ActiveMerchant::Shipping::Location.from(@locations[:beverly_hills].to_hash, :company_name => "Mine")
